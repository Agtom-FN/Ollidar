...
// ROUND 16: submap_at, sym_eigen3, normal_coverage, voxel_key_of,
// occupied_voxels and revisit_overlap now live in post_geom.h — the same code,
// moved so `section_stitch.cpp` and `loop_end.cpp` share one copy of the
// arithmetic rather than three. See that header for why.
using detail::normal_coverage;
