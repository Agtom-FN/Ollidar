...
then
  /opt/homebrew/share/android-commandlinetools/cmake/3.31.6/bin/ninja $targets_to_make ${EIGEN_MAKE_ARGS}
else
  /opt/homebrew/share/android-commandlinetools/cmake/3.31.6/bin/ninja $targets_to_make 
fi
exit $?
